...
if __name__ == '__main__':
    ...
    parser.add_argument('coco_json', help='coco.json file to be converted', default='datasets/elba/test.json')
    parser.add_argument(
        'data_path', help='Images data path, must match coco json filenames', default='datasets/elba/test')
    parser.add_argument(
        'output_dir', help='Output dir, must not previously exist', default='datasets/elba/test_ann_labelme')
